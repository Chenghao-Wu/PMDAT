...
def displacement_loop(analysis,Trj):
    ...
    for timegapii in range(n_exponential_steps,analysis.List.System.c_NumberTimeGaps-1):
        displacement_count=0
    ...
    nextii_array=Trj.loc[analysis.List.System.c_NumberSteps-1].values
    analysis.list_displacementkernel(analysis.List.System.c_NumberTimeGaps-1,thisii_array,nextii_array)